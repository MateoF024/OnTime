...
public class PlaceholderAPIIntegration {
    ...
    public static void register(OnTimeAPI api) {
        for (var entry : PlaceholderResolvers.all().entrySet()) {
            ...
            // The constructor, not fromNamespaceAndPath: that factory arrived
            // after 1.20.1 and the constructor it replaced is still here.
            Placeholders.register(new ResourceLocation("ontime", entry.getKey()),
                    (ctx, arg) -> {
