...
public class PlaceholderAPIIntegration {
    ...
    public static void register(OnTimeAPI api) {
        Placeholders.registerServer(Identifier.fromNamespaceAndPath("ontime", "active_name"),
        ...
        Placeholders.registerServer(Identifier.fromNamespaceAndPath("ontime", "active_time"),
                (ctx, arg) -> api.getActiveTimer()
                        .map(t -> {
        ...
        Placeholders.registerServer(Identifier.fromNamespaceAndPath("ontime", "active_percent"),
                (ctx, arg) -> api.getActiveTimer()
        ...
        Placeholders.registerServer(Identifier.fromNamespaceAndPath("ontime", "active_running"),
                (ctx, arg) -> api.getActiveTimer()
        ...
        Placeholders.registerServer(Identifier.fromNamespaceAndPath("ontime", "active_mode"),
                (ctx, arg) -> api.getActiveTimer()
                        .map(t -> PlaceholderResult.value(Component.literal(t.countUp() ? "count-up" : "countdown")))
                        .orElse(PlaceholderResult.value(Component.empty())));

        Placeholders.registerServer(Identifier.fromNamespaceAndPath("ontime", "active_seconds"),
                (ctx, arg) -> api.getActiveTimer()
                        .map(t -> PlaceholderResult.value(Component.literal(String.valueOf(t.getCurrentSeconds()))))
                        .orElse(PlaceholderResult.value(Component.literal("0"))));

        Placeholders.registerServer(Identifier.fromNamespaceAndPath("ontime", "timer_time"),
                (ctx, arg) -> {
        ...
        Placeholders.registerServer(Identifier.fromNamespaceAndPath("ontime", "timer_percent"),
                (ctx, arg) -> {
                    if (arg == null || arg.isEmpty()) return PlaceholderResult.invalid("Missing timer name");
                    return api.getTimer(arg)
                            .map(t -> PlaceholderResult.value(Component.literal(String.format("%.1f", t.getPercentage()))))
        ...
        Placeholders.registerServer(Identifier.fromNamespaceAndPath("ontime", "timer_running"),
                (ctx, arg) -> {
                    if (arg == null || arg.isEmpty()) return PlaceholderResult.invalid("Missing timer name");
                    return api.getTimer(arg)
                            .map(t -> PlaceholderResult.value(Component.literal(String.valueOf(t.running()))))
        ...
        Placeholders.registerServer(Identifier.fromNamespaceAndPath("ontime", "timer_exists"),
                (ctx, arg) -> {
                    if (arg == null || arg.isEmpty()) return PlaceholderResult.invalid("Missing timer name");
                    return PlaceholderResult.value(Component.literal(String.valueOf(api.hasTimer(arg))));
                });

        Placeholders.registerServer(Identifier.fromNamespaceAndPath("ontime", "timer_seconds"),
                (ctx, arg) -> {
                    if (arg == null || arg.isEmpty()) return PlaceholderResult.invalid("Missing timer name");
                    return api.getTimer(arg)
                            .map(t -> PlaceholderResult.value(Component.literal(String.valueOf(t.getCurrentSeconds()))))
